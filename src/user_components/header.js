...
const handleSignOut = () => {
  ...
  return (
    <header className=' w-full h-14 bg-whitw shadow-2xl opacity-4  text-black text-center'>
      ...
      <div className='text-xl italic font-sans font-bold ml-8 cursor-pointer'onClick={()=>handleNavigate('/')}>nusadglobalventures</div>
      <div className='mr-4 flex justify-end w-20'>
        <div className='text-3xl font-extrabold cursor-pointer' onClick={handleSignOut}>{<RxExit/>}</div>
      </div>
      </div>
